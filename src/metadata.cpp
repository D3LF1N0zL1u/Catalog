...
iceberg_meta_get_table_for_update(const char *namespace_name, const char *table_name)
{
    ...
    if (SPI_processed > 0)
    {
        ...
        /* col 5: metadata_location (NOT NULL) */
        {
        ...
        /* col 9: current_schema_id (nullable) */
        {
            bool isnull;
        ...
        /* col 10: current_snapshot_id (nullable) */
        {
            bool isnull;
        ...
        /* col 11: default_spec_id (nullable) */
        {
            bool isnull;
