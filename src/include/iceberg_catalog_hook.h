 ...
 *
 * Other extensions can register callbacks via the rendezvous variable
 * ICEBERG_CREATE_DELTA_TABLE_HOOK_VAR.  iceberg_catalog will invoke the
 * registered callback during CREATE TABLE processing.
 *
 *-------------------------------------------------------------------------
 */
