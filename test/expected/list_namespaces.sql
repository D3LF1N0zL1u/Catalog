...
gsql:test/sql/list_namespaces.sql:59: ERROR:  pageSize must be >= 1
...
gsql:test/sql/list_namespaces.sql:64: ERROR:  pageSize must be >= 1
CONTEXT:  referenced column: list_namespaces
...
gsql:test/sql/list_namespaces.sql:73: ERROR:  The given namespace does not exist
CONTEXT:  referenced column: list_namespaces
